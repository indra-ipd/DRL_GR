...
if __name__ == "__main__":
    ...
    os.chdir('..')
    os.system('rmdir /s /q benchmark')
    os.system('rmdir /s /q capacityplot_A')
    os.system('rmdir /s /q solutionsA')
    os.system('rmdir /s /q benchmark_reduced')
    os.system('rmdir /s /q capacityplot_A_reduced')
    os.system('rmdir /s /q solutionsA_reduced')
...
#            print(via_capacity[i,j])
    ...
    if not os.path.exists('../capacityPlot_A_reduced/'):
...
#            print(via_capacity[i,j])
    ...
    plt.colorbar()
    plt.gca().invert_yaxis()
    try:os.mkdir('../capacityPlot_A_reduced')
    except:pass
